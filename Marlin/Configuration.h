...
#define STRING_CONFIG_H_AUTHOR "David Bittner" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Printtner"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80*2, 80*2, 400*2, 415*2*2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -7, 38, -1.13 }
